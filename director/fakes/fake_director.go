...
type FakeDirector struct {
	...
	EventsStub        func(map[string]interface{}) ([]director.Event, error)
...
func (fake *FakeDirector) Events(arg1 map[string]interface{}) ([]director.Event, error) {
...
func (fake *FakeDirector) EventsArgsForCall(i int) map[string]interface{} {
	fake.eventsMutex.RLock()
	defer fake.eventsMutex.RUnlock()
